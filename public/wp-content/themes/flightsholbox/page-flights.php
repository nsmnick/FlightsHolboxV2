        ...
        <div class="container prices-page__container">
            ...
            <?php if ($searched) : ?>
                ...
                <?php else : ?>
                    <div class="prices-page__no-results">
                        <p>No prices found for that combination. Try adjusting your search or <a href="<?php echo esc_url(site_url('/private-flight-prices-holbox')); ?>">view all prices</a>.</p>
                    </div>
                <?php endif; ?>
            ...
            <?php else : ?>
                <div class="prices-page__prompt">
                    ...
                    <a href="<?php echo esc_url(site_url('/private-flight-prices-holbox')); ?>" class="button">View all prices</a>
                </div>
            <?php endif; ?>
